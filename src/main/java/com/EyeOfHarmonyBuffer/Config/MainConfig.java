...
public class MainConfig {
    ...
    public static void loadConfig() {
        ...
        NaquadahFuelOutPutMagnificationTrue = config.get("硅岩反应堆","开启修改枯竭燃料产出",NaquadahFuelOutPutMagnificationTrue,"开启后可以自定义枯竭燃料产出倍率")
            .getBoolean(NaquadahFuelOutPutMagnificationTrue);

        NaquadahFuelOutPutMagnification = config.get("硅岩反应堆","枯竭燃料产出倍率",NaquadahFuelOutPutMagnification,"设置枯竭燃料产出倍率")
