...
public final class ExampleQuestRegistration {
    ...
    public static void registerAll() {
        QuestDefinition starterQuest = Quests.quest("eyeofharmonybuffer.Arknights_Section_One_1")
        ...
        ChapterDefinition chapter = Chapters.chapter("eyeofharmonybuffer.Arknights_Section_One")
            .uuid(START)
            .icon(MODID + ":YuanShi", 1, 0)
            .quest(new QuestPlacementDefinition(starterQuest, 0, 0, 20, 20))
            .build();
