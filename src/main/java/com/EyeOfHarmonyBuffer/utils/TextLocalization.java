...
public class TextLocalization {
    ...
    public static final String Tooltip_DysonCore_04;
    public static final String Tooltip_DysonCore_05;
    public static final String Tooltip_DysonCore_06;
    public static final String Tooltip_DysonCore_07;
    public static final String Tooltip_DysonCore_08;
    public static final String Tooltip_DysonCore_09;
    public static final String Tooltip_DysonCore_10;
    public static final String Tooltip_DysonCore_11;
    public static final String Tooltip_DysonCore_12;
    public static final String Tooltip_DysonCore_13;
    public static final String Tooltip_DysonCore_14;
    public static final String Tooltip_DysonCore_15;
    public static final String Tooltip_DysonCore_16;
    public static final String Tooltip_DysonCore_17;
    public static final String Tooltip_DysonCore_18;
    public static final String Tooltip_DysonCore_19;
    public static final String Tooltip_DysonCore_20;
    public static final String Tooltip_DysonCore_21;
    public static final String Tooltip_DysonCore_22;
    ...
    public static final String Tooltip_DysonManufacturingModule_Controller;
    ...
    public static final String Tooltip_DysonManufacturingModule_04;
    public static final String Tooltip_DysonManufacturingModule_05;
    public static final String Tooltip_DysonManufacturingModule_06;
    public static final String Tooltip_DysonManufacturingModule_07;
    public static final String Tooltip_DysonManufacturingModule_08;
    public static final String Tooltip_DysonManufacturingModule_09;
    public static final String Tooltip_DysonManufacturingModule_10;
    public static final String Tooltip_DysonManufacturingModule_11;
    public static final String Tooltip_DysonManufacturingModule_12;

    public static final String NameDysonLaunchModule;
    public static final String Tooltip_DysonLaunchModule_MachineType;
    public static final String Tooltip_DysonLaunchModule_Controller;
    ...
    public static final String Tooltip_DysonLaunchModule_04;
    public static final String Tooltip_DysonLaunchModule_05;
    public static final String Tooltip_DysonLaunchModule_06;
    public static final String Tooltip_DysonLaunchModule_07;
    public static final String Tooltip_DysonLaunchModule_08;
    public static final String Tooltip_DysonLaunchModule_09;
    public static final String Tooltip_DysonLaunchModule_10;
    public static final String Tooltip_DysonLaunchModule_11;

    public static final String NameDysonMassLaunchModule;
    public static final String Tooltip_DysonMassLaunchModule_MachineType;
    public static final String Tooltip_DysonMassLaunchModule_Controller;
    ...
    public static final String Tooltip_DysonMassLaunchModule_04;
    public static final String Tooltip_DysonMassLaunchModule_05;
    public static final String Tooltip_DysonMassLaunchModule_06;
    public static final String Tooltip_DysonMassLaunchModule_07;
    public static final String Tooltip_DysonMassLaunchModule_08;
    public static final String Tooltip_DysonMassLaunchModule_09;
    public static final String Tooltip_DysonMassLaunchModule_10;

    public static final String NameDysonReceiverModule;
    public static final String Tooltip_DysonReceiverModule_MachineType;
    public static final String Tooltip_DysonReceiverModule_Controller;
    ...
    public static final String Tooltip_DysonReceiverModule_03;
    public static final String Tooltip_DysonReceiverModule_04;
    public static final String Tooltip_DysonReceiverModule_05;
    public static final String Tooltip_DysonReceiverModule_06;
    public static final String Tooltip_DysonReceiverModule_07;
    public static final String Tooltip_DysonReceiverModule_08;
    public static final String Tooltip_DysonReceiverModule_09;
    public static final String Tooltip_DysonReceiverModule_10;
    public static final String Tooltip_DysonReceiverModule_11;
    ...
    public static final String Dyson_Info_Linked;
    public static final String Dyson_Info_NotLinked;
    public static final String Dyson_Link_StickName;
    public static final String Dyson_Link_Saved;
    public static final String Dyson_Link_Success;
    ...
    //机载状态屏（DysonStatusScreen）
    public static final String Dyson_Holo_Title;
    public static final String Dyson_Holo_Team;
    public static final String Dyson_Holo_OrbitProgress;
    public static final String Dyson_Holo_PersonalStock;
    public static final String Dyson_Holo_Progress;
    public static final String Dyson_Holo_LinkModule;
    public static final String Dyson_Holo_Compute;
    public static final String Dyson_Holo_Sphere;
    public static final String Dyson_Holo_ComputeOK;
    public static final String Dyson_Holo_ComputeLow;
    public static final String Dyson_Holo_Completed;
    public static final String Dyson_Holo_UnderConstruction;
    public static final String Dyson_Holo_MsgDuplicate;
    public static final String Dyson_Holo_MsgWon;
    public static final String Dyson_Holo_MsgLost;
    public static final String Dyson_Holo_MsgOnline;
    public static final String Dyson_Stat_CloudComponent;
    public static final String Dyson_Stat_FrameComponent;
    ...
    static{
        ...
        Tooltip_DysonCore_03 = TextHandler.texter("Module slots unlock with your team's paste progress: 0 / 500k / 1M / 1.5M / completed to 8 / 12 / 16 / 20 / 32 slots. The final 12 slots open only on the day the shell is finished.","Tooltip_DysonCore_03");
        Tooltip_DysonCore_04 = TextHandler.texter("Every module must stay inside the Orundum power field; leaving Talos 2 shuts the core down instantly.","Tooltip_DysonCore_04");
        Tooltip_DysonCore_05 = TextHandler.texter("Heartbeat signals keep modules alive: after a shutdown or chunk unload, modules disconnect within 2 seconds.","Tooltip_DysonCore_05");
        Tooltip_DysonCore_06 = TextHandler.texter("Consumes 1,000,000 computation from the owner's personal network; insufficient compute shuts the whole core down.","Tooltip_DysonCore_06");
        Tooltip_DysonCore_07 = TextHandler.texter("The core passively produces Strange Matter from your team's cloud and paste counts, stored as the owner's personal asset.","Tooltip_DysonCore_07");
        Tooltip_DysonCore_08 = TextHandler.texter("Teammates may each build their own core, all pushing the same team counters.","Tooltip_DysonCore_08");
        Tooltip_DysonCore_09 = TextHandler.texter("Components are personal property; once launched they belong to the team - leave the team and the sky stays behind.","Tooltip_DysonCore_09");
        Tooltip_DysonCore_10 = TextHandler.texter("When R&D first hauled the core to Talos, nobody accounted for the star's actual size.","Tooltip_DysonCore_10");
        Tooltip_DysonCore_11 = TextHandler.texter("Halfway through assembly, the shell turned out smaller than the star. The engineer fixed three revisions overnight.","Tooltip_DysonCore_11");
        Tooltip_DysonCore_12 = TextHandler.texter("The next morning he announced with dark circles: We have decided to shrink the star.","Tooltip_DysonCore_12");
        Tooltip_DysonCore_13 = TextHandler.texter("The cafeteria's steamed buns kept shrinking. At 3 AM, half-eaten buns sat on the blueprint desk.","Tooltip_DysonCore_13");
        Tooltip_DysonCore_14 = TextHandler.texter("Overtime makes you hungry, and hunger makes you misread the scale. - R&D cafeteria files.","Tooltip_DysonCore_14");
        Tooltip_DysonCore_15 = TextHandler.texter("An intern asked why not rent an existing ring. The manager replied: Rings are rented, but the shell is ours.","Tooltip_DysonCore_15");
        Tooltip_DysonCore_16 = TextHandler.texter("On completion, the core announces the owner's team and resets every other team's progress.","Tooltip_DysonCore_16");
        Tooltip_DysonCore_17 = TextHandler.texter("All launching is permanently locked - including for the owner. The orbit is full, and the slingshot goes home.","Tooltip_DysonCore_17");
        Tooltip_DysonCore_18 = TextHandler.texter("Warning! Don't casually dismantle a completed core: modules lose their heartbeat, counters won't roll back.","Tooltip_DysonCore_18");
        Tooltip_DysonCore_19 = TextHandler.texter("The final 12 slots unlock after completion, reserved for receiver and future functional modules.","Tooltip_DysonCore_19");
        Tooltip_DysonCore_20 = TextHandler.texter("The winning core still outputs power at 10^200 - provided it ever recovers from this project.","Tooltip_DysonCore_20");
        Tooltip_DysonCore_21 = TextHandler.texter("The box that swallowed the sun - presented by Endfield Industry, Seventh Construction Department.","Tooltip_DysonCore_21");
        Tooltip_DysonCore_22 = TextHandler.texter("Good luck, Administrator.","Tooltip_DysonCore_22");
        ...
        Tooltip_DysonManufacturingModule_Controller = TextHandler.texter("Controller block of the Dyson Manufacturing Module","Tooltip_DysonManufacturingModule_Controller");
        Tooltip_DysonManufacturingModule_00 = TextHandler.texter("The production line module that turns raw materials into Dyson Cloud and Frame components - the first pair of hands.","Tooltip_DysonManufacturingModule_00");
        Tooltip_DysonManufacturingModule_01 = TextHandler.texter("The module footprint expands one layer with input buses and hatches; products go straight into the owner's personal stock.","Tooltip_DysonManufacturingModule_01");
        Tooltip_DysonManufacturingModule_02 = TextHandler.texter("Fed Originite Prime and Xirang become component stock, with no physical items ejected.","Tooltip_DysonManufacturingModule_02");
        Tooltip_DysonManufacturingModule_03 = TextHandler.texter("Base round time 30s, base parallel 64; upgrades push the round down to 15 / 10 / 5s.","Tooltip_DysonManufacturingModule_03");
        Tooltip_DysonManufacturingModule_04 = TextHandler.texter("Parallel goes up to 128 / 512; Parallel III also gives a 20% chance for 100~200x extra output per round.","Tooltip_DysonManufacturingModule_04");
        Tooltip_DysonManufacturingModule_05 = TextHandler.texter("Costs go to the team Orundum ledger: 1B/t for cloud, 5B/t for frame.","Tooltip_DysonManufacturingModule_05");
        Tooltip_DysonManufacturingModule_06 = TextHandler.texter("Consumes 10,000 computation; no paste threshold, and it keeps working after completion.","Tooltip_DysonManufacturingModule_06");
        Tooltip_DysonManufacturingModule_07 = TextHandler.texter("During the first test run, R&D dumped a whole crate of Originite Prime into the hopper.","Tooltip_DysonManufacturingModule_07");
        Tooltip_DysonManufacturingModule_08 = TextHandler.texter("The machine hummed for thirty seconds and produced a row of Cloud components - everyone thought it was broken because it made no sound.","Tooltip_DysonManufacturingModule_08");
        Tooltip_DysonManufacturingModule_09 = TextHandler.texter("A veteran craftsman sighed: If our village forge were this quiet, I'd have been out of a job long ago.","Tooltip_DysonManufacturingModule_09");
        Tooltip_DysonManufacturingModule_10 = TextHandler.texter("Rumor has it a worker once threw snacks into the hopper to test parallel 512; the machine spat out unknown components.","Tooltip_DysonManufacturingModule_10");
        Tooltip_DysonManufacturingModule_11 = TextHandler.texter("The Safety Department has placed that worker on a watch list.","Tooltip_DysonManufacturingModule_11");
        Tooltip_DysonManufacturingModule_12 = TextHandler.texter("Unused components make great heirlooms.","Tooltip_DysonManufacturingModule_12");
        ...
        Tooltip_DysonLaunchModule_Controller = TextHandler.texter("Controller block of the Dyson Launch Module","Tooltip_DysonLaunchModule_Controller");
        Tooltip_DysonLaunchModule_00 = TextHandler.texter("Launches the owner's personal components into orbit: 1 component = 1 count, clouds and frames each into their own pool.","Tooltip_DysonLaunchModule_00");
        Tooltip_DysonLaunchModule_01 = TextHandler.texter("Base round time 10s with up to 16 components; upgrades push it to 5 / 2s.","Tooltip_DysonLaunchModule_01");
        Tooltip_DysonLaunchModule_02 = TextHandler.texter("Batch goes up to 64 / 128; with Dual Launch, clouds and frames fire independently, up to 256 per round.","Tooltip_DysonLaunchModule_02");
        Tooltip_DysonLaunchModule_03 = TextHandler.texter("Before Dual Launch, only the priority type is fired (cloud-first / frame-first); no stock means idle, not switching.","Tooltip_DysonLaunchModule_03");
        Tooltip_DysonLaunchModule_04 = TextHandler.texter("Launch costs 10,000 Orundum per component on the team ledger; funds are checked before components are consumed.","Tooltip_DysonLaunchModule_04");
        Tooltip_DysonLaunchModule_05 = TextHandler.texter("Consumes 100,000 computation; needs no hatches, because its true body is a very large slingshot.","Tooltip_DysonLaunchModule_05");
        Tooltip_DysonLaunchModule_06 = TextHandler.texter("After completion all launching is permanently locked - including for the owner. The slingshot goes home.","Tooltip_DysonLaunchModule_06");
        Tooltip_DysonLaunchModule_07 = TextHandler.texter("Engineers first proposed a coilgun; the test projectile fell back onto the pad and smashed three floor tiles.","Tooltip_DysonLaunchModule_07");
        Tooltip_DysonLaunchModule_08 = TextHandler.texter("Change it. To a slingshot. - design meeting minutes, verbatim.","Tooltip_DysonLaunchModule_08");
        Tooltip_DysonLaunchModule_09 = TextHandler.texter("The current module uses a giant mechanical arm that gently tosses components into orbit, accurate to millimeters.","Tooltip_DysonLaunchModule_09");
        Tooltip_DysonLaunchModule_10 = TextHandler.texter("Operators call it the gentle parabola.","Tooltip_DysonLaunchModule_10");
        Tooltip_DysonLaunchModule_11 = TextHandler.texter("Players ask why launching costs Orundum. Finance replies: Throwing accurately is not free.","Tooltip_DysonLaunchModule_11");
        ...
        Tooltip_DysonMassLaunchModule_Controller = TextHandler.texter("Controller block of the Dyson Mass Launch Module","Tooltip_DysonMassLaunchModule_Controller");
        Tooltip_DysonMassLaunchModule_00 = TextHandler.texter("One 60s round launches ALL of the owner's personal cloud and frame components into orbit.","Tooltip_DysonMassLaunchModule_00");
        Tooltip_DysonMassLaunchModule_01 = TextHandler.texter("Mass means exactly that.","Tooltip_DysonMassLaunchModule_01");
        Tooltip_DysonMassLaunchModule_02 = TextHandler.texter("Requires the Mass Launch major node; without it the module is just a sculpture.","Tooltip_DysonMassLaunchModule_02");
        Tooltip_DysonMassLaunchModule_03 = TextHandler.texter("Clamped by the team's 50k cloud / 500k frame caps; overflow stays in the personal stock.","Tooltip_DysonMassLaunchModule_03");
        Tooltip_DysonMassLaunchModule_04 = TextHandler.texter("Costs 10,000 Orundum per component on the team ledger; consumes 100,000 computation.","Tooltip_DysonMassLaunchModule_04");
        Tooltip_DysonMassLaunchModule_05 = TextHandler.texter("Permanently disabled after completion. Its finest moment is dumping the last crate into orbit.","Tooltip_DysonMassLaunchModule_05");
        Tooltip_DysonMassLaunchModule_06 = TextHandler.texter("R&D originally called it the Dump-Everything Machine; the name became Mass Launch after an executive complained.","Tooltip_DysonMassLaunchModule_06");
        Tooltip_DysonMassLaunchModule_07 = TextHandler.texter("The warehouse keeper still calls it the clearance sale.","Tooltip_DysonMassLaunchModule_07");
        Tooltip_DysonMassLaunchModule_08 = TextHandler.texter("Its control logic is simple: All of it, right now. No turning back.","Tooltip_DysonMassLaunchModule_08");
        Tooltip_DysonMassLaunchModule_09 = TextHandler.texter("A safety officer suggested a confirmation button; the engineer refused on the spot.","Tooltip_DysonMassLaunchModule_09");
        Tooltip_DysonMassLaunchModule_10 = TextHandler.texter("Someone who clicks Mass Launch needs no second confirmation.","Tooltip_DysonMassLaunchModule_10");
        ...
        Tooltip_DysonReceiverModule_Controller = TextHandler.texter("Controller block of the Dyson Receiver Module","Tooltip_DysonReceiverModule_Controller");
        Tooltip_DysonReceiverModule_00 = TextHandler.texter("Brings the team's power back home.","Tooltip_DysonReceiverModule_00");
        Tooltip_DysonReceiverModule_01 = TextHandler.texter("Before completion, power = cloud x 2^41 + paste x 2^79 (EU/t).","Tooltip_DysonReceiverModule_01");
        Tooltip_DysonReceiverModule_02 = TextHandler.texter("Settles once per second, crediting P x 20 each time; the pure-cloud route works too.","Tooltip_DysonReceiverModule_02");
        Tooltip_DysonReceiverModule_03 = TextHandler.texter("After completion only the winning team keeps receiving, at a fixed 10^200.","Tooltip_DysonReceiverModule_03");
        Tooltip_DysonReceiverModule_04 = TextHandler.texter("One receiver per team, first come first served; another can take over if the active one fails.","Tooltip_DysonReceiverModule_04");
        Tooltip_DysonReceiverModule_05 = TextHandler.texter("The GUI sets the Orundum share (0-100), splitting output between the Orundum and wireless EU ledgers.","Tooltip_DysonReceiverModule_05");
        Tooltip_DysonReceiverModule_06 = TextHandler.texter("Consumes no computation and needs zero paste. In essence it is a giant satellite dish.","Tooltip_DysonReceiverModule_06");
        Tooltip_DysonReceiverModule_07 = TextHandler.texter("During testing, the numbers exploded instantly and every light in the building flickered for one second.","Tooltip_DysonReceiverModule_07");
        Tooltip_DysonReceiverModule_08 = TextHandler.texter("This dish is a bit strong. - first line of the test report.","Tooltip_DysonReceiverModule_08");
        Tooltip_DysonReceiverModule_09 = TextHandler.texter("The power could blow up the wireless ledger, so the receiver got a splitter valve.","Tooltip_DysonReceiverModule_09");
        Tooltip_DysonReceiverModule_10 = TextHandler.texter("Divide by percentage first, then credit slowly.","Tooltip_DysonReceiverModule_10");
        Tooltip_DysonReceiverModule_11 = TextHandler.texter("The cafeteria lady threw away her solar water heater and asked: When is the home version coming?","Tooltip_DysonReceiverModule_11");
        ...
        Dyson_Info_Linked = TextHandler.texter("Linked to core: (%s, %s, %s)","Dyson_Info_Linked");
        Dyson_Info_NotLinked = TextHandler.texter("Not linked to a Dyson Core","Dyson_Info_NotLinked");
        Dyson_Link_StickName = TextHandler.texter("Dyson Core Link Data Stick","Dyson_Link_StickName");
        Dyson_Link_Saved = TextHandler.texter("Saved Dyson Core link data to Data Stick","Dyson_Link_Saved");
        Dyson_Link_Success = TextHandler.texter("Link successful","Dyson_Link_Success");
        ...
        //机载状态屏（DysonStatusScreen）
        Dyson_Holo_Title = TextHandler.texter("Dyson Core · Onboard Status Screen","Dyson_Holo_Title");
        Dyson_Holo_Team = TextHandler.texter("Team: ","Dyson_Holo_Team");
        Dyson_Holo_OrbitProgress = TextHandler.texter("—— Orbit Progress ——","Dyson_Holo_OrbitProgress");
        Dyson_Holo_PersonalStock = TextHandler.texter("—— Personal Stock ——","Dyson_Holo_PersonalStock");
        Dyson_Holo_Progress = TextHandler.texter("Progress: ","Dyson_Holo_Progress");
        Dyson_Holo_LinkModule = TextHandler.texter("Link Module","Dyson_Holo_LinkModule");
        Dyson_Holo_Compute = TextHandler.texter("Compute","Dyson_Holo_Compute");
        Dyson_Holo_Sphere = TextHandler.texter("Dyson Sphere","Dyson_Holo_Sphere");
        Dyson_Holo_ComputeOK = TextHandler.texter("OK","Dyson_Holo_ComputeOK");
        Dyson_Holo_ComputeLow = TextHandler.texter("Low","Dyson_Holo_ComputeLow");
        Dyson_Holo_Completed = TextHandler.texter("Completed","Dyson_Holo_Completed");
        Dyson_Holo_UnderConstruction = TextHandler.texter("Under Construction","Dyson_Holo_UnderConstruction");
        Dyson_Holo_MsgDuplicate = TextHandler.texter("⚠ Duplicate core detected: this machine has shut down. Dismantle the extra core.","Dyson_Holo_MsgDuplicate");
        Dyson_Holo_MsgWon = TextHandler.texter("Your team completed the Dyson Sphere!","Dyson_Holo_MsgWon");
        Dyson_Holo_MsgLost = TextHandler.texter("The Dyson Sphere was completed by another team","Dyson_Holo_MsgLost");
        Dyson_Holo_MsgOnline = TextHandler.texter("Core online · hologram syncing","Dyson_Holo_MsgOnline");
        Dyson_Stat_CloudComponent = TextHandler.texter("Cloud Component","Dyson_Stat_CloudComponent");
        Dyson_Stat_FrameComponent = TextHandler.texter("Frame Component","Dyson_Stat_FrameComponent");
