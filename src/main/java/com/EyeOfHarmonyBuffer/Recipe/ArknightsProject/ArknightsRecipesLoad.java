...
import static com.EyeOfHarmonyBuffer.Recipe.RecipeMaps.*;
    ...
    public void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                ItemList.Circuit_Parts_ResistorSMD.get(16),
                ...
                GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Palladium, 64)
            )
            .fluidInputs(
                EOHBMaterialPool.JingZhiDianJiJiang.getFluidOrGas(4000)
            )
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTUtility.copyAmount(0, GTCMItemList.YiTieKuai.get(1)),
                GTOreDictUnificator.get(OrePrefixes.dust, EOHBGTMaterials.QingMengKuang, 16),
                GTCMItemList.GuYuanYanZu.get(8)
            )
            .fluidInputs(
                EOHBMaterialPool.HuanTingJuHeWu.getFluidOrGas(1000),
                EOHBMaterialPool.JingZhiQieXiaoYe.getFluidOrGas(1000)
            )
            .fluidOutputs(
                EOHBMaterialPool.GaoJieJingLianYe.getFluidOrGas(1000)
            )
            .eut(500000)
            .duration(10 * SECONDS)
            .addTo(ReactorCrucible);
