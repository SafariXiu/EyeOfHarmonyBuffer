...
public class BlueDogDeviceFrontend extends RecipeMapFrontend {

    private static final int xDirMaxCount = 4; // 每行最大槽位数
    private static final int yOrigin = 20; // Y 轴起始位置

    public BlueDogDeviceFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder, NEIRecipePropertiesBuilder neiPropertiesBuilder) {
    ...
    public List<Pos2d> getItemOutputPositions(int itemOutputCount) {
        // 物品输出槽位（4x1 布局）
        return UIHelper.getGridPositions(itemOutputCount, 100, 20, xDirMaxCount);
    }
