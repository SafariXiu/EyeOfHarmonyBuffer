...
public class GrinderFrontend extends RecipeMapFrontend {

    public GrinderFrontend(BasicUIPropertiesBuilder uiProps,
    ...
    public List<Pos2d> getItemInputPositions(int itemInputCount) {
        return UIHelper.getGridPositions(itemInputCount, 36, yOrigin, xDirMaxCount);
    }
    ...
    public List<Pos2d> getFluidOutputPositions(int fluidOutputCount) {
        return UIHelper.getGridPositions(fluidOutputCount, 119, yOrigin, xDirMaxCount);
    }
