...
public class DysonMassLaunchModule extends DysonModuleBase<DysonMassLaunchModule>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_DysonMassLaunchModule_MachineType)
            .addInfo(Tooltip_DysonMassLaunchModule_Controller)
            ...
            .addInfo(Tooltip_DysonMassLaunchModule_04)
            .addInfo(Tooltip_DysonMassLaunchModule_05)
            .addInfo(Tooltip_DysonMassLaunchModule_06)
            .addInfo(Tooltip_DysonMassLaunchModule_07)
