...
public class DysonManufacturingModule extends DysonModuleBase<DysonManufacturingModule>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_DysonManufacturingModule_MachineType)
            .addInfo(Tooltip_DysonManufacturingModule_Controller)
            ...
            .addInfo(Tooltip_DysonManufacturingModule_04)
            .addInfo(Tooltip_DysonManufacturingModule_05)
            .addInfo(Tooltip_DysonManufacturingModule_06)
            .addInfo(Tooltip_DysonManufacturingModule_07)
            .addInfo(Tooltip_DysonManufacturingModule_08)
            .addInfo(Tooltip_DysonManufacturingModule_09)
