...
public class DysonCore extends OrundumWirelessMultiMachineBase<DysonCore>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_DysonCore_MachineType)
            .addInfo(Tooltip_DysonCore_Controller)
            ...
            .addInfo(Tooltip_DysonCore_04)
            .addInfo(Tooltip_DysonCore_05)
            .addInfo(Tooltip_DysonCore_06)
            .addInfo(Tooltip_DysonCore_07)
            .addInfo(Tooltip_DysonCore_08)
            .addInfo(Tooltip_DysonCore_09)
            .addInfo(Tooltip_DysonCore_10)
            .addInfo(Tooltip_DysonCore_11)
            .addInfo(Tooltip_DysonCore_12)
            .addInfo(Tooltip_DysonCore_13)
            .addInfo(Tooltip_DysonCore_14)
            .addInfo(Tooltip_DysonCore_15)
            .addInfo(Tooltip_DysonCore_16)
            .addInfo(Tooltip_DysonCore_17)
            .addInfo(Tooltip_DysonCore_18)
            .addInfo(Tooltip_DysonCore_19)
