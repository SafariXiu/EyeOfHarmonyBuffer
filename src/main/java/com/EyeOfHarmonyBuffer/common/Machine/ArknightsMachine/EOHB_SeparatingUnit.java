...
public class EOHB_SeparatingUnit extends UpgradableOrundumWirelessMultiMachineBase<EOHB_SeparatingUnit>
    implements IConstructable, ISurvivalConstructable {

    private static IStructureDefinition<EOHB_SeparatingUnit> STRUCTURE_DEFINITION = null;
    private static final String STRUCTURE_PIECE_MAIN = "mainSeparatingUnit";
    private static final int OffsetsX = 8;
    private static final int OffsetsY = 11;
    private static final int OffsetsZ = 0;
    private static final int CASING_INDEX = 16;

    public EOHB_SeparatingUnit(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
        setWirelessCycleNum(1);
    }

    public EOHB_SeparatingUnit(String aName) {
        super(aName);
        setWirelessCycleNum(1);
    }
    ...
    public RecipeMap<?> getRecipeMap() {
        return RecipeMaps.SeparatingUnit;
    }
    ...
    private static final String[][] shapeMain = new String[][]{
        {"                 ","                 ","                 ","                 ","   C         C   ","   C         C   ","                 ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","      BB BB      ","   A  BB BB  A   ","   A  BB BB  A   ","      BB BB      ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","      BB BB      ","   ACCCCCCCCCA   ","   ACCCCCCCCCA   ","      BB BB      ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","       A A       ","   A   AAA   A   ","   A   AAA   A   ","       A A       ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","                 ","   A   DAD   A   ","   A   DAD   A   ","                 ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","       A A       ","   A    A    A   ","   A    A    A   ","       A A       ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","       A A       ","   A         A   ","   A         A   ","       A A       ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","                 ","   AC       CA   ","   AC       CA   ","                 ","                 ","                 ","                 "},
        {"                 ","                 ","                 ","   CCC     CCC   ","  CACC     CCAC  ","  CACC     CCAC  ","   CCC     CCC   ","                 ","                 ","                 "},
        {"                 ","                 ","  CCCCC   CCCCC  ","  CCCCCCCCCCCCC  ","  CACCC A CCCAC  ","  CACCC A CCCAC  ","  CCCCCCCCCCCCC  ","  CCCCC   CCCCC  ","                 ","                 "},
    ...
    @Override
    public IStructureDefinition<EOHB_SeparatingUnit> getStructureDefinition() {
        if(STRUCTURE_DEFINITION == null){
            STRUCTURE_DEFINITION = StructureDefinition.<EOHB_SeparatingUnit>builder()
                .addShape(
                ...
                .addElement(
                    'E',
                    buildHatchAdder(EOHB_SeparatingUnit.class)
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_SeparatingUnit_MachineType)
            .addInfo(Tooltip_SeparatingUnit_Controller)
            .addInfo(EOHB_Arknights_Project)
            .addInfo(Tooltip_SeparatingUnit_00)
            .addInfo(Tooltip_SeparatingUnit_01)
            .addInfo(Tooltip_SeparatingUnit_02)
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new EOHB_SeparatingUnit(this.mName);
    }
