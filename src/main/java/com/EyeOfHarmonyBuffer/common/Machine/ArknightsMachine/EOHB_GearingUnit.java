...
public class EOHB_GearingUnit extends UpgradableOrundumWirelessMultiMachineBase<EOHB_GearingUnit>
    implements IConstructable, ISurvivalConstructable {

    private static IStructureDefinition<EOHB_GearingUnit> STRUCTURE_DEFINITION = null;
    private static final String STRUCTURE_PIECE_MAIN = "mainGearingUnit";
    private static final int OffsetsX = 8;
    private static final int OffsetsY = 8;
    private static final int OffsetsZ = 0;
    private static final int CASING_INDEX = 16;

    public EOHB_GearingUnit(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
        setWirelessCycleNum(1);
    }

    public EOHB_GearingUnit(String aName) {
        super(aName);
        setWirelessCycleNum(1);
    }
    ...
    private static final String[][] shapeMain = new String[][]{
        {"                 "," CCCCCCCCCCCC    ","            C    ","       AAA  C    ","    DDDAAADDC    ","    CDDAAADDD    ","    C  AAA       ","    C            ","    CCCCCCCCCCCC ","                 "},
        {"                 "," BCCCCCCCCCCC    "," C          C    ","            C    ","        A        ","        A        ","    C            ","    C          C ","    CCCCCCCCCCCB ","                 "},
        {"                 "," CCCC            "," C               "," C               ","        A        ","        A        ","               C ","               C ","            CCCC ","                 "},
        {"                 "," CCCC            "," C               "," C               "," C      B        ","        B      C ","               C ","               C ","            CCCC ","                 "},
        {"                 ","  CCC            "," C               "," C               "," C               ","               C ","               C ","               C ","            CCC  ","                 "},
        {"                 "," AAAAAA   AAAAAA "," CCCCC  C  CCCCC "," CCCCC     CCCCC "," CCCCC     CCCCC "," CCCCC A A CCCCC "," CCCCC  A  CCCCC "," CCCCC  C  CCCCC "," AAAAAA   AAAAAA ","                 "},
        {"                 ","     AAAAAAA     ","      A C A      ","      A A A      ","      AA AA      ","      AA AA      ","      A A A      ","      A C A      ","     AAAAAAA     ","                 "},
        {"BEEEEEEEEEEEEEEEB","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","BEEEEEEEEEEEEEEEB"},
        {"BEEEEEEE~EEEEEEEB","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","EEEEEEEEEEEEEEEEE","BEEEEEEEEEEEEEEEB"}
    };

    @Override
    public IStructureDefinition<EOHB_GearingUnit> getStructureDefinition() {
        if(STRUCTURE_DEFINITION == null){
            STRUCTURE_DEFINITION = StructureDefinition.<EOHB_GearingUnit>builder()
                .addShape(
                ...
                .addElement(
                    'E',
                    buildHatchAdder(EOHB_GearingUnit.class)
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_GearingUnit_MachineType)
            .addInfo(Tooltip_GearingUnit_Controller)
            .addInfo(EOHB_Arknights_Project)
            .addInfo(Tooltip_GearingUnit_00)
            .addInfo(Tooltip_GearingUnit_01)
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new EOHB_GearingUnit(this.mName);
    }
