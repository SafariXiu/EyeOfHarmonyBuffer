...
public class DysonLaunchModule extends DysonModuleBase<DysonLaunchModule>
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(Tooltip_DysonLaunchModule_MachineType)
            .addInfo(Tooltip_DysonLaunchModule_Controller)
            ...
            .addInfo(Tooltip_DysonLaunchModule_04)
            .addInfo(Tooltip_DysonLaunchModule_05)
            .addInfo(Tooltip_DysonLaunchModule_06)
            .addInfo(Tooltip_DysonLaunchModule_07)
            .addInfo(Tooltip_DysonLaunchModule_08)
