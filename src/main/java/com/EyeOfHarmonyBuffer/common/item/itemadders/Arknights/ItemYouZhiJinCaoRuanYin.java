...
public class ItemYouZhiJinCaoRuanYin extends Item {

    public ItemYouZhiJinCaoRuanYin(){
        this.setUnlocalizedName("YouZhiJinCaoRuanYin");
        this.setTextureName(EyeOfHarmonyBuffer.MODID + ":Arknights/YouZhiJinCaoRuanYin");
