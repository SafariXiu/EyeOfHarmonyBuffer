...
public class ItemYouZhiQiaoYuJiaoNang extends Item {

    public ItemYouZhiQiaoYuJiaoNang(){
        this.setUnlocalizedName("YouZhiQiaoYuJiaoNang");
        this.setTextureName(EyeOfHarmonyBuffer.MODID + ":Arknights/YouZhiQiaoYuJiaoNang");
