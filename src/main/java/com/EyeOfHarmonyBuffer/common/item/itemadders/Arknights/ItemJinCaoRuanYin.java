...
public class ItemJinCaoRuanYin extends Item {

    public ItemJinCaoRuanYin(){
        this.setUnlocalizedName("JinCaoRuanYin");
        this.setTextureName(EyeOfHarmonyBuffer.MODID + ":Arknights/JinCaoRuanYin");
