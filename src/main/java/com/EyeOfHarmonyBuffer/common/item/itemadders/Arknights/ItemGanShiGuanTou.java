...
public class ItemGanShiGuanTou extends Item {

    public ItemGanShiGuanTou() {
        this.setUnlocalizedName("GanShiGuanTou");
        this.setTextureName(EyeOfHarmonyBuffer.MODID + ":Arknights/GanShiGuanTou");
